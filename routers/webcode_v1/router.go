...
func DefaultH(c *gin.Context) gin.H {
    ...
    if strings.Index(Language, "cn")!=-1{
        configs.Lang="cn"
        CkeditLanguage="zh-cn"
        HomePage="<a href='http://www.kdhly.com' target=_blank>golangbbs.com</a>"
        if strings.Index(c.Request.Host,"golangbbs.com")>-1  && configs.CheckPortOpen("golangbbs.ddns.net",8008){
          c.Redirect(http.StatusFound, "http://golangbbs.ddns.net:8008")
          c.Abort()
        }
    }
